...
[Components]
  ...
  #
  #ShellPkg/Application/FirstUefiApp/FirstUefiApp.inf  #The first App from MichaelLu ReadGPT
  ShellPkg/Application/ReadGPT/ReadGPT.inf 
  ShellPkg/Application/SystemTable/SystemTable.inf 
